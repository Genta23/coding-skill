...
int main(){
    //vector<string> data = {".ABC.", "ABC..", "BC..A", "C..AB", "..ABC"};
    int n; cin >> n;
    string r, c; cin >> r >> c;

    //stringのvectorの使い方が間違っていたのと
    //出力手法が違った
    ...
    //cout << endl;
    //data = {"AC..B", "B.A.C", "C.BA.", ".ACB.", ".B.CA"};
    //data = {"AC..B", ".BA.C", "C.BA.", "BA.C.", "..CBA"};
    //data = {"AC..B", "..CBA", "C.BA.", "BA.C.", ".BA.C"};
    for(string x : data) {
        string t = x;
        cout << t << endl;
    }
