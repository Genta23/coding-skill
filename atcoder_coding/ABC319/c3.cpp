...
int main(){
    ...
    do{
        ...
        rep(i, 9){
            ...
            if(x == 0) vec[0].push_back(c[y][x]);
            if(x == 1) vec[1].push_back(c[y][x]);
            if(x == 2) vec[2].push_back(c[y][x]);

            if(y == 0) vec[3].push_back(c[y][x]);
            if(y == 1) vec[4].push_back(c[y][x]);
            if(y == 2) vec[5].push_back(c[y][x]);
